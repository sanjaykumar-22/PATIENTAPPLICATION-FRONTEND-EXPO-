...
const DoctorList = () => {
  ...
  const { departmentId, departmentName, selectedDate, id } = route.params; // Destructure the route ID
  ...
  const handleDoctorPress = (doctorId, doctorName) => {
    navigation.navigate("CareType", {
      doctorId,
      doctorName,
      departmentId,
      departmentName,
      selectedDate,
      id, // Pass the route ID to the CareTypeSelectionPage
    });
  };
